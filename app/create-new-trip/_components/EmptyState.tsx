  ...
  return (
    <div className="text-center px-6 py-4">
      ...
      <p className="text-gray-600 mb-6">
        Discover personalised travel itineraries, find the best destinations,
        and plan your dream vacation effortlessly. Let our smart AI assistant do
        the hard work while you enjoy the journey.
      </p>
